...
public class TextColorPreference extends DialogPreference
implements SeekBar.OnSeekBarChangeListener {
    ...
    protected void onBindDialogView(View view) {
        ...
        int current = BatteryStatusTextPreference.getWidgetTextColor2(getContext());
        if (current == 0x01000000) {
            // assume old setting. try to read old setting.
            current = BatteryStatusTextPreference.getWidgetTextColor(getContext());
        }
    ...
    private void initViews(View view, int color) {
        ...
        mString[RED] = view.getResources().getString(R.string.setting_color_red);
        ...
        mString[GREEN] = view.getResources().getString(R.string.setting_color_green);
        ...
        mString[BLUE] = view.getResources().getString(R.string.setting_color_blue);
        ...
        mString[ALPHA] = view.getResources().getString(R.string.setting_color_alpha);
